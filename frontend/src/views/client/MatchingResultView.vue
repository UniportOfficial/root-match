...
const factories = computed<FactoryRecommendation[]>(
  () => workflowStore.recommendations,
);
const selectedFactory = computed<FactoryRecommendation | null>(
  () => workflowStore.selectedFactory,
);
...
<template>
  <div class="min-h-screen bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- 에러 상태 -->
      <div
        v-else-if="workflowStore.matchingError"
        class="rounded-2xl border border-red-200 bg-red-50 p-8 text-center"
      >
        <p class="font-bold text-red-700">{{ workflowStore.matchingError }}</p>
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <div class="relative min-w-[160px]">
              ...
              <div class="relative">
                ...
                >
                  <option
                    v-for="option in trustScoreOptions"
                    :key="option"
                    :value="option"
                  >
                    {{ option }}
        ...
        <div class="flex flex-col lg:flex-row gap-6">
          ...
          <div class="flex-1 space-y-4">
            ...
            >
              ...
              <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4">
                ...
                <div class="flex items-center gap-2 col-span-2 sm:col-span-2">
                  ...
                  <div>
                    ...
                    <p class="text-sm font-semibold text-slate-900">
                      {{ formatPrice(factory.estimateMin) }} ~
                      {{ formatPrice(factory.estimateMax) }}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <!-- AI Reason -->
              <div
                class="flex items-start gap-2 p-3 bg-blue-50 rounded-lg mb-4"
              >
          ...
          <div class="lg:w-80 lg:sticky lg:top-8 lg:self-start">
            ...
            >
              <div
                class="bg-gradient-to-r from-slate-800 to-slate-900 px-5 py-4"
              >
              ...
              <div v-if="selectedFactory" class="p-5">
                  ...
                  <div>
                    ...
                    <div class="h-2 bg-slate-100 rounded-full overflow-hidden">
                      <div
                        ...
                        :style="{
                          width: `${selectedFactory.priceCompetitiveness}%`,
                        }"
                      ></div>
                    </div>
                  </div>
                ...
                <!-- AI Summary -->
                <div
                  class="mt-6 p-4 bg-gradient-to-br from-slate-50 to-slate-100 rounded-lg"
                >
