import type { TransactionCase, TransactionStatus } from '@rootmatching/shared'
    ...
    updates: [
      {
        title: '계약 및 결제 완료',
        date: '2026.05.16',
        description: '에스크로 결제와 전자서명이 완료되었습니다.',
      },
      {
        title: '소재 절단 완료',
        date: '2026.05.20',
        description: '스테인리스 원소재 절단 및 가공 준비 완료',
      },
      {
        title: '1차 용접 완료',
        date: '2026.05.26',
        description: '브라켓 본체 용접과 치수 확인 진행',
      },
    ],
  },
  {
    ...
    updates: [
      {
        title: '금형 설계 착수',
        date: '2026.05.08',
        description: '초기 설계와 게이트 위치 검토 시작',
      },
      {
        title: '설계 수정 요청',
        date: '2026.05.19',
        description: '조립부 간섭 이슈로 설계 수정 요청',
      },
      {
        title: '일정 재산정',
        date: '2026.05.25',
        description: '추가 가공 범위 반영 후 일정 재검토 중',
      },
    ],
  },
  {
    ...
    updates: [
      {
        title: '계약 및 결제 완료',
        date: '2026.05.24',
        description: '전자계약과 에스크로 결제가 완료되어 제작이 시작되었습니다.',
      },
      {
        title: '소재 발주 완료',
        date: '2026.05.25',
        description: 'AL6061 판재 발주와 입고 일정이 확정되었습니다.',
      },
      {
        title: '1차 셋업 진행',
        date: '2026.05.28',
        description: 'CNC 지그 셋업과 초도 가공 준비가 진행 중입니다.',
      },
    ],
  },
  {
    ...
    deliveryFile: {
      name: 'robot_cover_painting_preview.zip',
      size: 3600000,
      type: 'application/zip',
    },
    inspectionFile: {
      name: 'dimension_check_sheet.xlsx',
      size: 540000,
      type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
    },
    updates: [
      {
        title: '판금 절곡 완료',
        date: '2026.05.23',
        description: '커버 본체 절곡과 용접 보강 작업이 완료되었습니다.',
      },
      {
        title: '치수 검사 완료',
        date: '2026.05.26',
        description: '주요 체결부와 외곽 치수 검사가 기준 범위 안으로 확인되었습니다.',
      },
      {
        title: '분체도장 진행',
        date: '2026.05.28',
        description: '무광 블랙 분체도장 작업이 진행 중이며 출하 전 외관 검사가 남아 있습니다.',
      },
    ],
  },
]
