...
const roles = [
  {
    ...
    features: ['수주 요청 등록', 'AI 추천 공장 비교', '계약 및 결제 관리'],
  ...
  },
  {
    ...
    features: ['공장 프로필 등록', '포트폴리오 관리', '견적 제출 및 정산'],
  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-4xl">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-slate-600">사용 목적에 따라 맞춤형 기능을 제공합니다.</p>
      </div>
      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        >
          <!-- Icon -->
          <div
            class="w-16 h-16 bg-emerald-100 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-emerald-500 transition-colors duration-300"
          >
            <component
              :is="role.icon"
